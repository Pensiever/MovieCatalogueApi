...
{
    public class CommentRepository : BaseRepository, ICommentRepository<Comment>
    {
        ...
        public IEnumerable<Comment> GetAll()
        {
            ...
            return _connection.ExecuteReader(cmd, Converter.CommentConvert);
        }
        ...
        public Comment GetOne(int Id)
        {
            ...
            cmd.AddParameter("Id", Id);
            return _connection.ExecuteReader(cmd, Converter.CommentConvert).FirstOrDefault();
        }
